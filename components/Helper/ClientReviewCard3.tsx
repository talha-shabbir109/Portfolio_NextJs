		...
		<div className="m-2 hover:bg-gray-700 transition-all duration-300 rounded-lg">
			<div className="border-2 p-4 border-gray-700 rounded-xl">
				...
				<p className="text-[15px] text-white opacity-65 mt-[3rem] text-center">
					Talha delivered a high-quality dashboard using Next.js and Tailwind
					CSS. His clean code, attention to detail, and UX/UI expertise created
					a smooth, efficient interface. His technical skills and dedication
					were key to the projects success.
				</p>
