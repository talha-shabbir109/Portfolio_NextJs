		...
		<div className="m-2 hover:bg-gray-700 transition-all duration-300 rounded-lg">
			<div className="border-2 p-4 border-gray-700 rounded-xl">
				...
				<p className="text-[15px] text-white opacity-65 mt-[3rem] text-center">
					Talha did an excellent job delivering top-notch development results.
					His attention to detail and technical skills helped create efficient
					and user-friendly solutions. His dedication and expertise made a real
